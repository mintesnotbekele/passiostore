    ...
    $(".save_coupon_btn").click(function(){
      ...
      if(code == ''){
       ...
       //   console.log('done'+vendorID+' '+expiresAt);
           ...
           database.collection('coupons').doc(id).set({'code':code,'description':description,'discount':discount,'expiresAt':expiresAt,'isEnabled':isEnabled,'id':id,'discountType':discountType,'image':photo,'vendorID':vandorId,'isPublic':isPublic}).then(function(result) {
