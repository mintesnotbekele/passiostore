        ...
        ref.get().then(async function (snapshots) {
            ...
            await database.collection('vendors').where('id', "==", product.vendorID).get().then(async function (vendorSnapshots) {
                ...
                if (section_id) {
                    ...
                    section.get().then(async function (snapshots) {
                        ...
                        if (section_data.dine_in_active == true) {
            ...
            if (product.hasOwnProperty("isDigitalProduct") && product.hasOwnProperty("digitalProduct")) {
                ...
                if (product.digitalProduct) {
                    ...
                    if(ext=='zip'){
                    $("#uploding_zip").html('<span class="image-item zip-file mt-2"><span class="delete-btn delete-zip" data-itemid="' + product.id + '" data-file="' + product.digitalProduct + '"><i class="fa fa-remove"></i></span><a href="'+product.digitalProduct+'" download><i class="fa fa-file-text" style="font-size:45px"></i></a></span>');

                    }
                    else if(ext=='pdf'){
                     $("#uploding_zip").html('<span class="image-item zip-file mt-2"><span class="delete-btn delete-zip" data-itemid="' + product.id + '" data-file="' + product.digitalProduct + '"><i class="fa fa-remove"></i></span><a href="'+product.digitalProduct+'"><i class="fa fa-file-text" style="font-size:45px"></i></a></span>');

                    }else{
                    $("#uploding_zip").html('<span class="image-item zip-file mt-2"><span class="delete-btn delete-zip" data-itemid="' + product.id + '" data-file="' + product.digitalProduct + '"><i class="fa fa-remove"></i></span><img width="100px" height="auto" src="'+product.digitalProduct+'"></span>');
        ...
        $(".save_item_btn").click(function () {
            ...
            if (name == '') {
                ...
                database.collection('vendor_products').doc(productId).update({
                    ...
                    'digitalProduct': digital_product_file ? digital_product_file : '',
                ...
                if (ext == "jpg" || ext == "jpeg" || ext == "png" || ext == "gif" || ext == "zip" || ext == "pdf") {
                    ...
                    uploadTask.on('state_changed', function (snapshot) {
                        ...
                        uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
                            ...
                            setTimeout(function () {
                            if(ext=="zip"){
                            $("#uploding_zip").html('<span class="image-item zip-file"><span class="delete-btn delete-zip" data-itemid="' + productId + '"  data-file="' + downloadURL + '"><i class="fa fa-remove"></i></span><a href="'+downloadURL+'" download><i class="fa fa-file-text" style="font-size:45px"></i></a></span>');

                            }else if(ext=='pdf'){    
                            $("#uploding_zip").html('<span class="image-item zip-file"><span class="delete-btn delete-zip" data-itemid="' + productId + '"  data-file="' + downloadURL + '"><i class="fa fa-remove"></i></span><a href="'+downloadURL+'" target="_blank"><i class="fa fa-file-text" style="font-size:45px"></i></a></span>');
                            }else{
                            $("#uploding_zip").html('<span class="image-item zip-file"><span class="delete-btn delete-zip" data-itemid="' + productId + '"  data-file="' + downloadURL + '"><i class="fa fa-remove"></i></span><img width="100px" id="" height="auto" src="' + downloadURL + '"></span>');
                            }
                            }, 2000);
